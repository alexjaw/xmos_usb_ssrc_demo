        ...
        select
        {
            ...
            case inuint_byref(c_sof, u_tmp):
                ...
                else
                {
                    ...
                    GET_SHARED_GLOBAL(cycles, g_curSamFreqMultiplier); //g_curSamFreqMultiplier = SR * 512 / MCLK. Ie. 1 for 4x, 2 for 8x etc.
                    ...
                    //Display sample rates on LEDs. Toggle each SOF loop for basic p_col_val muxing
                    if (toggle == 0){
                        toggle ++;
                        switch (sampleFreq){
                        case 44100:
